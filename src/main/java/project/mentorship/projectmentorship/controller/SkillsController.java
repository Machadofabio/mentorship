...
import project.mentorship.projectmentorship.service.impl.FindSkillsServiceImpl;
...
public class SkillsController {
    ...
    @Autowired
    FindSkillsServiceImpl findSkillsService;
    ...
    public ResponseEntity<List<String>> getAllSoftSkills(){
        return ResponseEntity.ok(findSkillsService.getAllSoftSkillsAvaliable());
    }
}
